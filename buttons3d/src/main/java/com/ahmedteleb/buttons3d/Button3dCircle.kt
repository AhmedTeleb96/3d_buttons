 ...
 */
class Button3dCircle : AppCompatButton, View.OnTouchListener{
    ...
    private fun createDrawable(radius: Int, topColor: Int, bottomColor: Int): LayerDrawable {
        ...
        //Top
        val topCircle = OvalShape()
        val topShapeDrawable = ShapeDrawable(topCircle)
        topShapeDrawable.paint.color = topColor
        //Bottom
        val bottomCircle = OvalShape()
        val bottomShapeDrawable = ShapeDrawable(bottomCircle)
